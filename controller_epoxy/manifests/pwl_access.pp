class controller_epoxy::pwl_access inherits controller_epoxy::params {
...
"
  ...
  File["nova_sshdir"] -> file {
	...
	"private_key":
	    source  => "puppet:///modules/controller_epoxy/$controller_epoxy::params::private_key",
	...
	"public_key":
            ...
            content => "$controller_epoxy::params::pub_key",
            owner   => nova,
            group   => nova;
