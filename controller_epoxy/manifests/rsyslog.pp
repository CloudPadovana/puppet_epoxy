...
#
     ...
     package { $rsyslogpackages: ensure => "installed" }
      ...
      file {'rsyslog_conf':
          source      => 'puppet:///modules/controller_epoxy/rsyslog.conf',
